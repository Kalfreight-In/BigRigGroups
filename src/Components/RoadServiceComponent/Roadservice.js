...
<<<<<<< HEAD
          <div className="2xl:ml-42 lg:ml-10 mr-10 xl:ml-28 md:ml-5   mb-10 mt-10 2xl:pt-12 pt-0 flex-1">
...
>>>>>>> e4c85f658685fba7009ca7ccadf0ad73b5b4091e
              24/7 Road Service
            </h1>
            <p
              //  className="text-white  font-desc 2xl:text-xl text-descnew 2xl:w-11/12 w-full 2xl:pl-0 pl-6 2xl:pt-4 pt-2"
              className="text-white font-desc 2xl:text-xl text-descnew lg:text-base md:text-sm px-0"
            >
